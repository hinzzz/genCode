...
public class GenUtils {
    ...
    public  List<String> getTemplates(TableEntity tableEntity) {
        ...
        genSqlXml.genSqlXmlFile(tableEntity);
    ...
    public  void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
            ...
            if(columnEntity.getAttrType().equals("Date") && checkDateName(columnEntity.getAttrName())){
                ColumnEntity date = new ColumnEntity();
                BeanUtils.copyProperties(columnEntity,date);
                date.setAttrName(date.getAttrName()+"Begin");
                date.setAttrname(date.getAttrname()+"Begin");
                date.setColumnName(date.getColumnName()+"Begin");
                columsList.add(date);
                BeanUtils.copyProperties(columnEntity,date);
                date.setAttrName(date.getAttrName()+"End");
                date.setAttrname(date.getAttrname()+"End");
                date.setColumnName(date.getColumnName()+"End");
                columsList.add(date);
            }
        ...
        //获取模板列表
        List<String> templates = getTemplates(tableEntity);
    ...
    private boolean checkDateName(String attrType) {
        ...
        for (String s1 : s) {
            if(attrType.contains(s1.toLowerCase())){
                return false;
            }
        }
        return true;
